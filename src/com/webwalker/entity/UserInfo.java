...
/**
 * 该文件通过代码生成器自动生成,只需编写模板,可以生成任何代码 具体请查看:
...
public class UserInfo {
	...
	public String toString() {
		return new ToStringBuilder(this).append("UserId", getUserId())
				...
				.append("BirthDate", getBirthDate()).append("Sex", getSex())
				.append("Age", getAge()).toString();
	}

	public int hashCode() {
		return new HashCodeBuilder().append(getUserId()).append(getUsername())
				.append(getPassword()).append(getBirthDate()).append(getSex())
				.append(getAge()).toHashCode();
	}
	...
	public boolean equals(Object obj) {
		...
		return new EqualsBuilder().append(getUserId(), other.getUserId())
				...
				.append(getAge(), other.getAge()).isEquals();
	}
}
